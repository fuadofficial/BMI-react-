      ...
      <ul className="list-group ">
        ...
        <li  className={ 18.5 < bmi && bmi <24.9 ? "border border-danger border-3 list-group-item" : "list-group-item"}>
          <div className="row">
            ...
            <div className="col-4 ">{range.normal.low + 'kg-' + range.normal.hegh + "kg"}</div>
          </div>
        </li>
        <li  className={ 24.9 < bmi && bmi < 29.9 ? "border border-danger border-3 list-group-item" : "list-group-item"}>
          <div className="row">
            ...
            <div className="col-4 ">{range.overWeight.low + 'kg-' + range.overWeight.hegh + "kg"}</div>
          </div>
        </li>
        <li className={ 29.9 < bmi && bmi < 34.9 ? "border border-danger border-3 list-group-item" : "list-group-item"}>
          <div className="row">
            ...
            <div className="col-4 ">{range.obesityOne.low + 'kg-' + range.obesityOne.hegh + "kg"}</div>
          </div>
        </li>
        <li className={ 34.9 < bmi && bmi < 39.9 ? "border border-danger border-3 list-group-item" : "list-group-item"}>
          <div className="row">
            ...
            <div className="col-4 ">{range.obesityTwo.low + 'kg-' + range.obesityTwo.hegh + "kg"}</div>
          </div>
        </li>
